...
import com.example.essam.movieapp.adapters.ReviewAdapter;
import com.example.essam.movieapp.adapters.TrailerAdapter;
...
public class DetailFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (mMovie != null) {
            ...
            action_favorite.setIcon(FavoritData.isFavorited(getActivity(), (int) mMovie.getId()) == 1 ?
            ...
            new AsyncTask<Void, Void, Integer>() {
                ...
                protected Integer doInBackground(Void... params) {
                    return FavoritData.isFavorited(getActivity(), (int) mMovie.getId());
                }
                                ...
                                new AsyncTask<Void, Void, Integer>() {
                                    ...
                                    protected Integer doInBackground(Void... params) {
                                        return getActivity().getContentResolver().delete(
                                                ...
                                                new String[]{Integer.toString((int) mMovie.getId())}
                                        );
                                    }
                            ...
                            // if it is not in favorites
                                ...
                                new AsyncTask<Void, Void, Uri>() {
                                    ...
                                    protected Uri doInBackground(Void... params) {
                                        ...
                                        values.put(MovieContract.MovieEntry.COLUMN_POSTER, mMovie.getImage());
                                        values.put(MovieContract.MovieEntry.COLUMN_BACKDROP, mMovie.getImage2());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mMovie != null) {
           ...
           // String image_url = FavoritData.buildImageUrl(342, mMovie.getImage2());

            Picasso.with(getContext()).load(FavoritData.buildImageUrl(342,mMovie.getImage2())).into(mImageView);
            ...
            mVoteAverageView.setText(Double.toString(mMovie.getRating()));
        }
    ...
    public void onStart() {
        super.onStart();
        if (mMovie != null) {
            new FetchTrailersTask().execute(Integer.toString((int) mMovie.getId()));
            new FetchReviewsTask().execute(Integer.toString((int) mMovie.getId()));
        }
    }
